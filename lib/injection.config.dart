...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i430.BreathingRepository>(
    ...
    gh.lazySingleton<_i263.GetBreathingSettings>(
      () => _i263.GetBreathingSettings(gh<_i430.BreathingRepository>()),
    );
    gh.lazySingleton<_i264.SaveBreathingSettings>(
      () => _i264.SaveBreathingSettings(gh<_i430.BreathingRepository>()),
    );
